      ...
      <page-tools :show-before="true">
        ...
        <template v-slot:after>
          <el-button
            size="mini"
            type="danger"
            @click="$router.push('/salary/setting')"
            >设置</el-button
          >
          <el-button
            size="mini"
            type="primary"
            @click="
              $router.push(`/salary/monthStatement?yearMonth=${yearMonth}`)
            "
          ...
          <el-table-column label="操作" width="260">
            <template slot-scope="scope" style>
              ...
              <el-button type="text" size="mini">
                <router-link
                  :to="{
                    path: '/salary/details/' + yearMonth + '/' + scope.row.id
                  }"
                  >查看</router-link
                >
              </el-button>
